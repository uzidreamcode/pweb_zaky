...
<body>
	...
	<div class="wrapper">
		...
		<div class="nav-container">
			...
			<nav class="topbar-nav">
				<ul class="metismenu" id="menu">
					...
					<li>
						<a href="admin.php?halaman=pembayaran">
					...
					<li>
						...
						<ul>
							<li> <a href="admin.php?halaman=rekap"><i class="bx bx-right-arrow-alt"></i>Rekap Pembayaran</a>
							</li>
							<li> <a href="admin.php?halaman=cetak_tagihan"><i class="bx bx-right-arrow-alt"></i>Cetak Tagihan</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul>
							<li> <a href="widgets.html"><i class="bx bx-right-arrow-alt"></i>Jurusan</a>
							</li>
							<li> <a href="component-alerts.html"><i class="bx bx-right-arrow-alt"></i>Siswa</a>
							</li>
							<li> <a href="component-alerts.html"><i class="bx bx-right-arrow-alt"></i>Kelas</a>
							</li>
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					if (isset($_GET['halaman'])) 
					{
						...
						elseif ($_GET['halaman']=='table-rekap') 
						{
							include 'table-rekap.php';
						}
					}
					else
					{
		...
		<!--footer -->
		<div class="footer">
			<p class="mb-0">Aplikasi SPP @2021
			</p>
		</div>
		<!-- end footer -->
	</div>
